...
export const UploadPhotos: React.FC = () => {
  ...
  // Allowed image formats and max file size (5 MB)
  ...
  return (
    <section className="bg-slate-50 border-y p-8 hover:border-t-4 hover:border-t-blue-variant hover:shadow-lg font-sans text-charcoal-gray my-4">
      ...
      <div className="border-2 border-dashed border-blue-variant lg:p-12 md:p-6 p-4 my-6">
        <div className="flex gap-4 justify-center items-center w-full">
          ...
          <div className="flex flex-col gap-1 self-end">
            <label htmlFor="file-upload" className="cursor-pointer">
              <div className="bg-blue-variant hover:bg-blue-800 py-2 md:px-6 px-3 rounded-lg text-center md:text-base text-sm text-white font-semibold h-fit self-center flex gap-2">
        ...
        <div className="grid 2xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-3 grid-cols-1 gap-4 my-8 max-md:flex max-md:flex-col max-md:items-center max-md:justify-center">
