...
export const CarInformation : React.FC <CarInformationProps> = ({bgcolor}) => {
  return (
    <section className={`bg-slate-100 border-y md:p-8 p-1 hover:border-t-4 hover:border-t-${bgcolor} hover:shadow-lg font-sans text-charcoal-gray my-4`}>
