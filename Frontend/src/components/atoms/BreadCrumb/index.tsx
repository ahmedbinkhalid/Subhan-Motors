...
const BreadCrumb: React.FC<BreadCrumbProps> = ({ title}) => {
  return (
      <div className="h-[47vh] bg-cover bg-center" style={{ backgroundImage: `url("https://t3.ftcdn.net/jpg/06/09/87/48/360_F_609874803_boIlmkyVD3R2Ui0qE8AiIcdfDBPzvez7.jpg")` }}>
