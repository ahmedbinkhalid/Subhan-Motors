...
export const FeaturedCarsCard  : React.FC  <FeaturedCarsCardProps> = ({carImage, carModel, carPrice, carCity}) => {
  return (
    <div className='flex flex-col justify-between bg-white shadow-md italic w-64 rounded-md my-1'>
        ...
        <h1 className='md:text-xl text-lg text-charcoal-gray font-semibold'>{carModel} </h1>
